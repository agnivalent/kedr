...
function useCalc(){
	...
	if (deposit.error){
		...
		var currencyStr;
		switch (currency){
			case 0: currencyStr = "<img src=\"images/ruble.svg\">"; $("#deposit_currency").html("руб."); break;
